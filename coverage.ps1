...
$report = Get-Content -Path MonitoringDeviceTest\TestResults\*\coverage.cobertura.xml | Out-String
$report = Get-Content -Path ConditionsAnalyzerTest\TestResults\*\coverage.cobertura.xml | Out-String
Write-Host "---------------------------------"
